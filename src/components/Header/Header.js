            ...
            <div className="header-container">
                <div className="header-content">
                    ...
                    <div className="right-section">
                        ...
                        {/* Espace Donateur */}
                        <button className="donor-space-button">
                ...
                {mobileMenuOpen && (
                    <div className={`mobile-menu ${mobileMenuOpen ? 'open' : ''}`}>
                        <div className="mobile-menu-content">
                            ...
                            {/* Menu Items Mobile */}
                            {menuItems.map((item, index) => (
                                <button key={index} className="nav-item-mobile">
                                    {item}
                                </button>
                            ))}

                            {/* Espace Donateur Mobile */}
                            <button className="donor-space-button-mobile">
                                <User className="donor-icon-mobile" />
                                Espace donateur
                            </button>

                            {/* Donation Button Mobile */}
                            <button className="donation-button-mobile">
